...
SEXP odin_model_2sp_tv1_set_user(SEXP internal_p, SEXP user) {
  ...
  internal->foi_age = (double*) user_get_array(user, false, internal->foi_age, "foi_age", NA_REAL, NA_REAL, 1, internal->dim_foi_age);
  internal->het_wt = (double*) user_get_array(user, false, internal->het_wt, "het_wt", NA_REAL, NA_REAL, 1, internal->dim_het_wt);
  internal->offset_output_EIR_species1 = internal->dim_cov + 60;
  internal->rel_foi = (double*) user_get_array(user, false, internal->rel_foi, "rel_foi", NA_REAL, NA_REAL, 1, internal->dim_rel_foi);
  internal->x_I = (double*) user_get_array(user, false, internal->x_I, "x_I", NA_REAL, NA_REAL, 1, internal->dim_x_I);
  R_Free(internal->b);
  internal->b = (double*) R_Calloc(internal->dim_b, double);
  ...
  internal->offset_FOIv_species2_ID = internal->dim_A + internal->dim_D + internal->dim_T + internal->dim_U;
  internal->offset_FOIv_species2_U = internal->dim_A + internal->dim_D + internal->dim_T;
  internal->offset_output_EIR = internal->dim_cov + internal->dim_EIR_species1 + internal->dim_EIR_species2 + 60;
  internal->offset_output_EIR_species2 = internal->dim_cov + internal->dim_EIR_species1 + 60;
  internal->offset_variable_A = internal->dim_D + internal->dim_S + internal->dim_T + 12;
  internal->offset_variable_D = internal->dim_S + internal->dim_T + 12;
  internal->offset_variable_IB = internal->dim_A + internal->dim_D + internal->dim_ICA + internal->dim_ICM + internal->dim_P + internal->dim_S + internal->dim_T + internal->dim_U + 12;
  internal->offset_variable_ICA = internal->dim_A + internal->dim_D + internal->dim_ICM + internal->dim_P + internal->dim_S + internal->dim_T + internal->dim_U + 12;
...
SEXP odin_model_2sp_tv1_metadata(SEXP internal_p) {
  ...
  SET_VECTOR_ELT(ret, 0, variable_length);
  UNPROTECT(2);
  SEXP output_length = PROTECT(allocVector(VECSXP, 64));
  SEXP output_names = PROTECT(allocVector(STRSXP, 64));
  setAttrib(output_length, R_NamesSymbol, output_names);
  SET_VECTOR_ELT(output_length, 0, R_NilValue);
  SET_VECTOR_ELT(output_length, 1, R_NilValue);
  SET_VECTOR_ELT(output_length, 2, R_NilValue);
  ...
  SET_VECTOR_ELT(output_length, 60, ScalarInteger(internal->dim_cov));
  SET_VECTOR_ELT(output_length, 61, allocVector(INTSXP, 3));
  int * dim_EIR_species1 = INTEGER(VECTOR_ELT(output_length, 61));
  dim_EIR_species1[0] = internal->dim_EIR_species1_1;
  dim_EIR_species1[1] = internal->dim_EIR_species1_2;
  dim_EIR_species1[2] = internal->dim_EIR_species1_3;
  SET_VECTOR_ELT(output_length, 62, allocVector(INTSXP, 3));
  int * dim_EIR_species2 = INTEGER(VECTOR_ELT(output_length, 62));
  dim_EIR_species2[0] = internal->dim_EIR_species2_1;
  dim_EIR_species2[1] = internal->dim_EIR_species2_2;
  dim_EIR_species2[2] = internal->dim_EIR_species2_3;
  SET_VECTOR_ELT(output_length, 63, allocVector(INTSXP, 3));
  int * dim_EIR = INTEGER(VECTOR_ELT(output_length, 63));
  dim_EIR[0] = internal->dim_EIR_1;
  dim_EIR[1] = internal->dim_EIR_2;
  dim_EIR[2] = internal->dim_EIR_3;
  SET_STRING_ELT(output_names, 0, mkChar("all_pop"));
  ...
  SET_STRING_ELT(output_names, 4, mkChar("theta_species1"));
  SET_STRING_ELT(output_names, 5, mkChar("theta_species2"));
  SET_STRING_ELT(output_names, 6, mkChar("ince1"));
  SET_STRING_ELT(output_names, 7, mkChar("incv1"));
  SET_STRING_ELT(output_names, 8, mkChar("ince2"));
  SET_STRING_ELT(output_names, 9, mkChar("incv2"));
  SET_STRING_ELT(output_names, 10, mkChar("Iv"));
  SET_STRING_ELT(output_names, 11, mkChar("sporozoite_rate_species1"));
  SET_STRING_ELT(output_names, 12, mkChar("sporozoite_rate_species2"));
  SET_STRING_ELT(output_names, 13, mkChar("Sout"));
  SET_STRING_ELT(output_names, 14, mkChar("Tout"));
  SET_STRING_ELT(output_names, 15, mkChar("Dout"));
  SET_STRING_ELT(output_names, 16, mkChar("Aout"));
  SET_STRING_ELT(output_names, 17, mkChar("Uout"));
  SET_STRING_ELT(output_names, 18, mkChar("Pout"));
  SET_STRING_ELT(output_names, 19, mkChar("prev"));
  SET_STRING_ELT(output_names, 20, mkChar("prev05"));
  SET_STRING_ELT(output_names, 21, mkChar("inc05"));
  SET_STRING_ELT(output_names, 22, mkChar("inc"));
  SET_STRING_ELT(output_names, 23, mkChar("mu1"));
  SET_STRING_ELT(output_names, 24, mkChar("mu2"));
  SET_STRING_ELT(output_names, 25, mkChar("beta_larval1"));
  SET_STRING_ELT(output_names, 26, mkChar("beta_larval2"));
  SET_STRING_ELT(output_names, 27, mkChar("mv"));
  SET_STRING_ELT(output_names, 28, mkChar("mv1"));
  SET_STRING_ELT(output_names, 29, mkChar("mv2"));
  SET_STRING_ELT(output_names, 30, mkChar("wh1"));
  SET_STRING_ELT(output_names, 31, mkChar("wh2"));
  SET_STRING_ELT(output_names, 32, mkChar("d_ITN_1"));
  SET_STRING_ELT(output_names, 33, mkChar("r_ITN_1"));
  SET_STRING_ELT(output_names, 34, mkChar("s_ITN_1"));
  SET_STRING_ELT(output_names, 35, mkChar("d_ITN_2"));
  SET_STRING_ELT(output_names, 36, mkChar("r_ITN_2"));
  SET_STRING_ELT(output_names, 37, mkChar("s_ITN_2"));
  SET_STRING_ELT(output_names, 38, mkChar("d_IRS_1"));
  SET_STRING_ELT(output_names, 39, mkChar("r_IRS_1"));
  SET_STRING_ELT(output_names, 40, mkChar("s_IRS_1"));
  SET_STRING_ELT(output_names, 41, mkChar("d_IRS_2"));
  SET_STRING_ELT(output_names, 42, mkChar("r_IRS_2"));
  SET_STRING_ELT(output_names, 43, mkChar("s_IRS_2"));
  SET_STRING_ELT(output_names, 44, mkChar("p1_1"));
  SET_STRING_ELT(output_names, 45, mkChar("p1_2"));
  SET_STRING_ELT(output_names, 46, mkChar("wbar1"));
  SET_STRING_ELT(output_names, 47, mkChar("wbar2"));
  SET_STRING_ELT(output_names, 48, mkChar("zbar1"));
  SET_STRING_ELT(output_names, 49, mkChar("zbar2"));
  SET_STRING_ELT(output_names, 50, mkChar("Q_1"));
  SET_STRING_ELT(output_names, 51, mkChar("Q_2"));
  SET_STRING_ELT(output_names, 52, mkChar("av1"));
  SET_STRING_ELT(output_names, 53, mkChar("av2"));
  SET_STRING_ELT(output_names, 54, mkChar("K0_species1"));
  SET_STRING_ELT(output_names, 55, mkChar("K0_species2"));
  SET_STRING_ELT(output_names, 56, mkChar("KL_species1"));
  SET_STRING_ELT(output_names, 57, mkChar("KL_species2"));
  SET_STRING_ELT(output_names, 58, mkChar("FOIv_species1"));
  SET_STRING_ELT(output_names, 59, mkChar("FOIv_species2"));
  SET_STRING_ELT(output_names, 60, mkChar("cov"));
  SET_STRING_ELT(output_names, 61, mkChar("EIR_species1"));
  SET_STRING_ELT(output_names, 62, mkChar("EIR_species2"));
  SET_STRING_ELT(output_names, 63, mkChar("EIR"));
  SET_VECTOR_ELT(ret, 1, output_length);
  UNPROTECT(2);
  SET_VECTOR_ELT(ret, 2, ScalarInteger(internal->dim_cov + internal->dim_EIR + internal->dim_EIR_species1 + internal->dim_EIR_species2 + 60));
  UNPROTECT(2);
  return ret;
}
SEXP odin_model_2sp_tv1_initial_conditions(SEXP internal_p, SEXP t_ptr) {
...
void odin_model_2sp_tv1_rhs(odin_model_2sp_tv1_internal* internal, double t, double * state, double * dstatedt, double * output) {
  ...
  if (output) {
    ...
    double sp_rate_species1 = Iv1 / (double) mv1;
    double sp_rate_species2 = Iv2 / (double) mv2;
    output[16] = odin_sum3(A, 0, internal->dim_A_1, 0, internal->dim_A_2, 0, internal->dim_A_3, internal->dim_A_1, internal->dim_A_12);
    output[38] = d_IRS_1;
    output[41] = d_IRS_2;
    output[32] = d_ITN_1;
    output[35] = d_ITN_2;
    output[15] = odin_sum3(D, 0, internal->dim_D_1, 0, internal->dim_D_2, 0, internal->dim_D_3, internal->dim_D_1, internal->dim_D_12);
    output[27] = mv;
    output[18] = odin_sum3(P, 0, internal->dim_P_1, 0, internal->dim_P_2, 0, internal->dim_P_3, internal->dim_P_1, internal->dim_P_12);
    output[39] = r_IRS_1;
    output[42] = r_IRS_2;
    output[33] = r_ITN_1;
    output[36] = r_ITN_2;
    output[13] = odin_sum3(S, 0, internal->dim_S_1, 0, internal->dim_S_2, 0, internal->dim_S_3, internal->dim_S_1, internal->dim_S_12);
    output[11] = sp_rate_species1;
    output[12] = sp_rate_species2;
    output[14] = odin_sum3(T, 0, internal->dim_T_1, 0, internal->dim_T_2, 0, internal->dim_T_3, internal->dim_T_1, internal->dim_T_12);
    output[17] = odin_sum3(U, 0, internal->dim_U_1, 0, internal->dim_U_2, 0, internal->dim_U_3, internal->dim_U_1, internal->dim_U_12);
    memcpy(output + 60, internal->cov, internal->dim_cov * sizeof(double));
    output[7] = incv1;
    output[9] = incv2;
    output[40] = s_IRS_1;
    output[43] = s_IRS_2;
    ...
    output[0] = H;
    output[58] = FOIv_species1;
    output[59] = FOIv_species2;
    for (int i = 1; i <= internal->age05; ++i) {
      for (int j = 1; j <= internal->dim_prev0to5_2; ++j) {
        for (int k = 1; k <= internal->dim_prev0to5_3; ++k) {
          internal->prev0to5[i - 1 + internal->dim_prev0to5_1 * (j - 1) + internal->dim_prev0to5_12 * (k - 1)] = T[internal->dim_T_12 * (k - 1) + internal->dim_T_1 * (j - 1) + i - 1] + D[internal->dim_D_12 * (k - 1) + internal->dim_D_1 * (j - 1) + i - 1] + A[internal->dim_A_12 * (k - 1) + internal->dim_A_1 * (j - 1) + i - 1] * internal->p_det[internal->dim_p_det_12 * (k - 1) + internal->dim_p_det_1 * (j - 1) + i - 1];
    ...
    output[6] = ince1;
    output[8] = ince2;
    output[19] = odin_sum3(internal->prev0to59, 0, internal->dim_prev0to59_1, 0, internal->dim_prev0to59_2, 0, internal->dim_prev0to59_3, internal->dim_prev0to59_1, internal->dim_prev0to59_12) / (double) odin_sum1(internal->den, 0, internal->age59);
    output[20] = odin_sum3(internal->prev0to5, 0, internal->dim_prev0to5_1, 0, internal->dim_prev0to5_2, 0, internal->dim_prev0to5_3, internal->dim_prev0to5_1, internal->dim_prev0to5_12) / (double) odin_sum1(internal->den, 0, internal->age05);
    for (int i = 1; i <= internal->age05; ++i) {
      for (int j = 1; j <= internal->dim_clin_inc0to5_2; ++j) {
        for (int k = 1; k <= internal->dim_clin_inc0to5_3; ++k) {
          internal->clin_inc0to5[i - 1 + internal->dim_clin_inc0to5_1 * (j - 1) + internal->dim_clin_inc0to5_12 * (k - 1)] = internal->clin_inc[internal->dim_clin_inc_12 * (k - 1) + internal->dim_clin_inc_1 * (j - 1) + i - 1];
    ...
    output[22] = odin_sum3(internal->clin_inc, 0, internal->dim_clin_inc_1, 0, internal->dim_clin_inc_2, 0, internal->dim_clin_inc_3, internal->dim_clin_inc_1, internal->dim_clin_inc_12);
    output[21] = odin_sum1(internal->clin_inc0to5, 0, internal->dim_clin_inc0to5) / (double) odin_sum1(internal->den, 0, internal->age05);
    output[30] = wh1;
    output[31] = wh2;
    output[48] = zbar1;
    output[49] = zbar2;
    ...
    output[23] = mu1;
    output[24] = mu2;
    output[25] = beta_larval1;
    output[26] = beta_larval2;
    memcpy(output + internal->offset_output_EIR_species1, internal->EIR_species1, internal->dim_EIR_species1 * sizeof(double));
    memcpy(output + internal->offset_output_EIR_species2, internal->EIR_species2, internal->dim_EIR_species2 * sizeof(double));
    memcpy(output + internal->offset_output_EIR, internal->EIR, internal->dim_EIR * sizeof(double));
    output[54] = K0_species1;
    output[55] = K0_species2;
    output[56] = KL_species1;
    output[57] = KL_species2;
  }
}
void odin_model_2sp_tv1_rhs_dde(size_t neq, double t, double * state, double * dstatedt, void * internal) {
...
SEXP odin_model_2sp_tv1_rhs_r(SEXP internal_p, SEXP t, SEXP state) {
  SEXP dstatedt = PROTECT(allocVector(REALSXP, LENGTH(state)));
  odin_model_2sp_tv1_internal *internal = odin_model_2sp_tv1_get_internal(internal_p, 1);
  SEXP output_ptr = PROTECT(allocVector(REALSXP, internal->dim_cov + internal->dim_EIR + internal->dim_EIR_species1 + internal->dim_EIR_species2 + 60));
  setAttrib(dstatedt, install("output"), output_ptr);
  UNPROTECT(1);
  double *output = REAL(output_ptr);
  const double initial_t = internal->initial_t;
